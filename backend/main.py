...
from routes import pest, crop, market, irrigation
...
app.include_router(market.router, prefix="/market", tags=["Market Prediction"])
app.include_router(irrigation.router, prefix="/irrigation", tags=["Irrigation Scheduling"])
